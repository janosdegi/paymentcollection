...
public class SearchPaymentsHandler {
  ...
  private final io.paymentcollection.payment.infrastructure.persistence.PaymentSearchQueryBuilder
      queryBuilder;
  ...
  public PaymentSearchResponse handle(PaymentSearchRequest request) {
    try {
      ...
      SearchResponse<PaymentSearchResultDto> response =
          elasticsearchClient.search(
              s ->
                  s.index("payments") // 👉 index name (infrastructure concern, could be config)
                      .query(query)
                      .from(from)
      ...
      List<PaymentSearchResultDto> payments =
